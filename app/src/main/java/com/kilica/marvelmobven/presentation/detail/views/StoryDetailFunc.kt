...
import com.kilica.marvelmobven.presentation.detail.views.storydetailrow.StoryComicRow
import com.kilica.marvelmobven.presentation.detail.views.storydetailrow.StoryCreatorsRow
import com.kilica.marvelmobven.presentation.detail.views.storydetailrow.StorySeriesRow
...
@Composable
fun StoryDetailFunc(story: Story) {
    val scrollState = rememberLazyListState()
    val isAgeIconClicked = remember { mutableStateOf(false) }
    val isWeightIconClicked = remember { mutableStateOf(false) }
    val isHeightIconClicked = remember { mutableStateOf(false) }
    val isUniverseIconClicked = remember { mutableStateOf(true) }
    ...
    LazyColumn(modifier = Modifier.fillMaxSize(), state = scrollState) {
        ...
        item {
            Row(
                ...
                // Each Column should be centered horizontally
                Column(
                ) {
                    Image(
                    ...
                    Text(
                        text = story.characters.available.toString(),
                ...
                Column(
                    ...
                    Text(
                        text = story.series.available.toString(),
                        modifier = Modifier.padding(8.dp),
                        color = Color.White
                    )
                }
                Column(
                    ...
                    Text(
                        text = story.events.available.toString(),
                        modifier = Modifier.padding(8.dp),
                        color = Color.White
                    )
                }
                Column(
                    ...
                    Text(
                        text = story.comics.available.toString(),
                        modifier = Modifier.padding(8.dp),
                        color = Color.White
                    )
                }
                Column(
                    ...
                    Text(
                        text = story.creators.available.toString(),
                        modifier = Modifier.padding(8.dp),
                        color = Color.White
                    )
                }
        ...
        item {
            Row(
                ...
                StatisticsBar(statisticValue = story.characters.available)
            }
        }
        item {
            Row(
                ...
                Spacer(modifier = Modifier.width(2.dp))
                StatisticsBar(statisticValue = story.series.available)
            }
        }
        item {
            Row(
                ...
                Spacer(modifier = Modifier.width(2.dp))
                StatisticsBar(statisticValue = story.events.available)
            }
        }
        item {
            Row(
                ...
                Spacer(modifier = Modifier.width(2.dp))
                StatisticsBar(statisticValue = story.comics.available)
            }
        }
        item {
            Row(
                ...
                Spacer(modifier = Modifier.width(2.dp))
                StatisticsBar(statisticValue = story.creators.available)
            }
        }
        item {
             if (isWeightIconClicked.value) {
                Text(
                    text = "SERIES",
                    modifier = Modifier
                        .fillMaxWidth()
        ...
        item {
            if (isUniverseIconClicked.value) {
                StoryComicRow(story = story)
            } else if (isComicIconClicked.value) {
                StoryCreatorsRow(story = story)
            } else if (isWeightIconClicked.value) {
                StorySeriesRow(story = story)
            }
        }
    }
}